    ...
    return declare("RangeSlider.widget.RangeSlider", [_WidgetBase, _TemplatedMixin], {
        ...
        _setupEvents: function () {
            ...
            this._options = {
                ...
                onSlide: dojoLang.hitch(this, this._onSlide)
            };
        ...
        _onSlide: function (value) {
            var handle = dojoQuery(".rangeslider__handle", this.rangeSliderNode);
              if (handle.length > 0) {
                if(this.showValue === "true" && this.absoluteValue === "true") {
                  dojoHtml.set(handle[0], "<span>"+Math.abs(this.rangeInputNode.value)+"</span>");
                } else if(this.showValue === "true" && this.absoluteValue === "false") {
                  dojoHtml.set(handle[0], "<span>"+this.rangeInputNode.value+"</span>");
                } else if(this.showValue === "false") {
                  dojoHtml.set(handle[0], "<span></span>");
                }
            }
